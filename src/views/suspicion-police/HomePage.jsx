...
// 跳转到全局视图    name: item.name,
  ...
  // caseId: item.name
SuspectLook=() => {
  window.open('/#/police/suspect-relation?name=' + this.state.name + '&idCardNum=' + this.state.idCardNum + '&caseId=' + this.state.caseId, '_self')
  ...
  showSearch = () => {
    this.setState({
      showSearch: this.state.showSearch === 1 ? 0 : 1
    })
  }
  ...
  render () {
    return (
      <div>
        {/* 案件相关人员begin */}
        <Button type='primary' onClick={this.showSearch}>{this.state.showSearch === 1 ? '隐藏检索栏' : '展开检索栏'}</Button>
        <div className={this.state.showSearch === 1 ? 'supicionPoliceHeader' : 'displayNone'} style={{margin: 0}}>
          ...
          <div className='headerButton'>
            ...
            <span> <a href='./#/police/suspicion-look'><Button type='primary' style={{marginRight: '30px'}} onClick={this.SuspectLook}>查看全局</Button> </a></span>
          ...
          <Tabs defaultActiveKey='1' onChange={this.searckCallBack}>
            ...
            <TabPane tab='详情' key='3' onChange={this.searckClickUnarrestSuspectInfo}>
              <div className='tableBox'>
                ...
                {/* 案件嫌疑人详情框end */}
                <div>
                  <Col span={12} style={{borderColor: 'rgba(45, 183, 245, 1)', height: '950px', width: '50%'}}>
